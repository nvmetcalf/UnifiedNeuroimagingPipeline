...
FSOUT="/scratch/FCStroke_freesurfer/native"
FSBIN="/usr/local/pkg/freesurfer5/bin"
StudyFolder="$1"
Subject="$2"
T1wFolder="$StudyFolder/$Subject/$3"
AtlasSpaceFolder="$StudyFolder/$Subject/$4"
NativeFolder="$5"
...
HighResMesh="${11}"
LowResMesh="${12}"
AtlasTransform="$StudyFolder/$Subject/atlas/xfms/${13}"
InverseAtlasTransform="$StudyFolder/$Subject/atlas/xfms/${14}"
...
#Import ROIs
if [ ! -e "$AtlasSpaceFolder"/ROIs/Atlas_ROIs."$GrayordinatesResolution".nii.gz ] ; then
...
if [ $status ] ; then
  ...
  if [ ! -e "$AtlasSpaceFolder"/fsaverage/"$Subject"."$Hemisphere".sphere."$HighResMesh"k_fs_"$Hemisphere".surf.gii ] ; then  
  ...
  if [ ! -e "$AtlasSpaceFolder"/fsaverage/"$Subject"."$Hemisphere".def_sphere."$HighResMesh"k_fs_"$Hemisphere".surf.gii ] ; then  
  ...
  if [ ! -e "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".sphere."$HighResMesh"k_fs_LR.surf.gii ] ; then
  ...
  if [ ! -e "$AtlasSpaceFolder"/fsaverage_LR"$LowResMesh"k/"$Subject"."$Hemisphere".sphere."$LowResMesh"k_fs_LR.surf.gii ] ; then
  ...
  if [ ! -e "$AtlasSpaceFolder"/"$Subject"."$Hemisphere".atlasroi."$HighResMesh"k_fs_LR.shape.gii ] ; then
  ...
  if [ ! -e "$AtlasSpaceFolder"/fsaverage_LR"$LowResMesh"k/"$Subject"."$Hemisphere".atlasroi."$LowResMesh"k_fs_LR.shape.gii ] ; then
