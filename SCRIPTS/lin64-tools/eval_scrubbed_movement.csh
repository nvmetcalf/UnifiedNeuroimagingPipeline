#!/bin/csh -f
#$Header: /data/petsun4/data1/solaris/csh_scripts/RCS/eval_scrubbed_movement.csh,v 1.5 2018/08/17 05:46:17 avi Exp $
#$Log: eval_scrubbed_movement.csh,v $
# Revision 1.5  2018/08/17  05:46:17  avi
# invoke with -f
#
# Revision 1.4  2016/03/16  00:31:07  avi
# tolerate running in movement subdirectory ($Edatfile logic)
#
# Revision 1.3  2014/03/03  22:57:31  avi
# correct usage
#
...
# Initial revision
#
set rcsid = '$Id: eval_scrubbed_movement.csh,v 1.5 2018/08/17 05:46:17 avi Exp $'
echo $rcsid
...
echo	mat2dat -RDL -f$fmt -r$radius $matfile
	...
	if (! $debug && ! $Edatfile) /bin/rm $datfile $rdatfile $ddatfile
	@ l += $nframe
	@ k++
end
cat $out
...
echo " e.g.:	"$program \"${format}\" "VB16168_xr3d.lst -H/data/nil-bluearc/raichle/avi/NP645/VB16168_TEST"
echo "	option"
echo "	-d	debug mode (preserve local dat and rdat files)"
echo "	-D	optionally use ddat file (default rdat)"
echo "	-H<dir>	specify directory containing BOLD subdirectories (defaults to cwd)"
