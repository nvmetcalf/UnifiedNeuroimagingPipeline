...
##############################################
#$Header: /data/petsun4/data1/solaris/csh_scripts/RCS/seed_correl_130715.csh,v 1.12 2018/08/17 05:52:21 avi Exp $
#$Log: seed_correl_130715.csh,v $
...
set rcsid = '$Id: seed_correl_130715.csh,v 1.12 2018/08/17 05:52:21 avi Exp $'
echo $rcsid
...
if (${#argv} < 1) then
	...
	echo "	-A	use format in atlas subdirectory (default FCmaps directory)"
	exit 1
endif 
date
uname -a
...
##################################
if (! ${?conc}) then
	set concroot	= ${patid}${MBstr}_xr3d_uwrp_atl		# default
	set conc	= $concroot.conc
else									# conc specified in params
	if (! -e $conc) then
