...
**			standard.
** Last Update:		$Author: jon $, $Date: 2016/12/09 17:06:59 $
...
/* 
** The writers of this code originally assumed that shorts are 16 bits long.
** If that is not the case, this system will not operate properly.

**  SIZEOF_SHORT, SIZEOF_INT, and SIZEOF_LONG defined in config.h.
*/
...
#else
#error DICOM library requires sizeof(short) = 2
#endif
#if SIZEOF_INT == 4
    ...
    typedef long S32;
#else
#error DICOM library requires 32 bit integer type.
#endif
