...
pushd ${SubjectHome}/Anatomical/Volume/FieldMapping_${FM_Suffix}
		...
		foreach direction($peds)
			...
			set bases	= $PP_SCRIPTS/Registration/FMAPBases/FNIRT_474_all_basis.4dfp.img	# I would not touch this
			set mean	= $PP_SCRIPTS/Registration/FMAPBases/FNIRT_474_all_mean.4dfp.img	# I would not touch this
