...
if __name__ == '__main__':
    ...
    if (len(sys.argv) != 4):
        ...
        parser = ParseParams(
            rules_path='/data/nil-bluearc/ances/PeteCanfield/ParseParams/TemplateParams.json', 
            boundary_path='/data/nil-bluearc/ances/PeteCanfield/ParseParams/Boundaries.json', 
