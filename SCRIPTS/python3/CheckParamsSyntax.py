...
class ParseParams():
    def __init__(self, rules_path    = os.path.join(os.path.expandvars('$PP_SCRIPTS'), 'python3', 'TemplateParams.json'),
                       boundary_path = os.path.join(os.path.expandvars('$PP_SCRIPTS'), 'python3', 'Boundaries.json'),
                       verbosity     = 2,
                       strictness    = 0):
