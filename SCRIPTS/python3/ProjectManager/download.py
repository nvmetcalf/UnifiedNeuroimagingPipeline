...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='A managment System for the Ances MR Processing Pipeline. Provides functionality for downloading and managing data.',
    ...
    if not '--project_alias_data_column' in sys.argv:
        require_global_project_alias = True

    if not '--global_project_alias' in sys.argv:
        require_project_alias_data_column = True
    ...
    settings.add_argument('--raw_data_destination_data_column',
                        required = False,
    ...
    def extract_and_prop() -> None:
        target_in_csv = not (args.project_alias_data_column == None)
        alias = args.project_alias_data_column if target_in_csv else args.global_project_alias
        ...
        downloader.extract_and_propagate_from_csv(
            ...
            alias,
            target_in_csv,
            args.raw_data_destination_data_column
        )
