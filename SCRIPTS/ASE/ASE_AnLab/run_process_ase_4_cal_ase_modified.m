...
function run_process_ase_4_cal_ase(name_dir_ase, nnn, numEcho, numFrame, numZshimming, maxTau, tauThresh1, tauThresh2, hct)
...
name_para = sprintf('%s/Original/%s_ase_para.dat', name_dir_ase, nnn);
