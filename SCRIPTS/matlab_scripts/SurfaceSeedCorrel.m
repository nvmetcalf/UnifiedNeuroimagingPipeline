...
%    assert(~Status);
    ...
    all_brainstructure  = raw_cii.brainstructure;
    ...
    if(CalculateSurfaceMaps)
        ...
        LH_Defined_Vertices = all_brainstructure(LH_Start:LH_End);
        LH_Defined_Vertices(LH_Defined_Vertices <= 0) = 0;
        LH_Defined_Vertices(LH_Defined_Vertices > 0) = 1;
        
        RH_Defined_Vertices = all_brainstructure(RH_Start:RH_End);
        RH_Defined_Vertices(RH_Defined_Vertices <= 0) = 0;
        RH_Defined_Vertices(RH_Defined_Vertices > 0) = 1;
        ...
        for i = 1:length(RegionList)
            ...
            Vertices = Cifti_ROI;
            Vertices(Vertices ~= RegionList(i)) = 0;
            ...
            LeftHemisphere_SurfaceMap = CiftiToGiftiAtlas( SurfaceMap(brainstructure == 1), LH_Defined_Vertices);
            RightHemisphere_SurfaceMap = CiftiToGiftiAtlas( SurfaceMap(brainstructure == 2), RH_Defined_Vertices);
            
            LeftHemisphere_ROI = CiftiToGiftiAtlas( Vertices(brainstructure == 1), LH_Defined_Vertices);
            RightHemisphere_ROI = CiftiToGiftiAtlas( Vertices(brainstructure == 2), RH_Defined_Vertices);
            
            save_gii([GiftiOutFile '_surface_map'], SurfaceSpace, LeftHemisphere_SurfaceMap, RightHemisphere_SurfaceMap);
            save_gii([GiftiOutFile '_region'], SurfaceSpace, LeftHemisphere_ROI, RightHemisphere_ROI);
        end
    end
