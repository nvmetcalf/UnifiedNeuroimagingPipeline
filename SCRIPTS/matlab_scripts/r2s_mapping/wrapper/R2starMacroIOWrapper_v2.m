%% R2starMacroIOWrapper_v2(input,TE,output,mask_filename,prefix,algorParam)
%
% Input
% --------------
...
%
function R2starMacroIOWrapper_v2(input,TE,outputDir,mask_filename,prefix,method,s0mode)
...
% GRE data
inputGRENifti = load_untouch_nii(input);
