...
switches.range = 6; % This is the range of TRs used in the cross-correlation 
...
switches.TR=2;
switches.savepng=1;
switches.QC = 0; % Make an image of the BOLD ave to make sure everything is registering properly.
...
concfile = '/data/nil-bluearc/corbetta/Studies/FCStroke/Subjects/FCS_024_A/FCmaps_no_wb_2018/FCS_024_A_faln_dbnd_xr3d_atl_g7_bpss_resid.conc'
tmask = '/data/nil-bluearc/corbetta/Studies/FCStroke/Subjects/FCS_024_A/FCmaps_no_wb_2018/DVAR_4.6/FCS_024_A_faln_dbnd_xr3d_atl_g7_bpss_resid.format'
outdir = '/data/nil-bluearc/corbetta/Studies/FCStroke/Subjects/FCS_024_A/FCmaps_no_wb_2018'

[LL]=MapLag(concfile,tmask,outdir,switches)
save LagLaterality.mat LL
