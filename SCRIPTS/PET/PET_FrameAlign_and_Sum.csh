...
pushd $ScratchDir
	...
	while($i <= $#PET_Images)
		...
		$PP_SCRIPTS/PET/Compute_corrected_sum.csh $PET_Images[$i] $DurationAfterPeak $PET_Isotope[$i] $PET_Modality[$i]_${i} $PET_FrameAlign[$i] $PET_SumMethod[$i] $FD_Threshold $BrainRadius
